...
def _collect_member_schedules(
    *,
    ...
    personal_schedules는 이미 date_from/date_to로 좁혀져서 들어오므로, 여기서는
    날짜로 다시 거르지 않습니다(_personal_schedules_for_current_scope 참고).
    """
        ...
        personal_rows.append(
            {
                ...
                "end_time": structured.end_time if end_time != "미정" else "18:00",
