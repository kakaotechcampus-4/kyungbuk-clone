...
def _personal_schedules_for_current_scope() -> list[dict[str, Any]]:
    ...
    saved_ids = {schedule.get("schedule_id") for schedule in sqlite_schedules if schedule.get("schedule_id")}
...
def _collect_member_schedules(
    *,
    ...
    for schedule in personal_schedules:
        ...
        date = request.date
        if normalized_date_from and (not date or date < normalized_date_from):
            continue
