    ...
    return [
        *week05_prompt_parts(),
        (
            ...
            "개인 일정 조회/생성/수정/삭제, todo/reminder 저장, 개인 참고자료나 내 대화 기록 검색처럼 "
...
def nana_prompt_parts() -> list[str]:
    ...
    return [
        *week04_prompt_parts(),
        (
            "너는 Nana다. 개인 일정 조회/생성/수정/삭제, todo/reminder 저장, 개인 참고자료 검색, "
            "내 대화 기록 검색만 담당한다. 외부 멤버와의 대화나 일정, 여러 사람의 일정 조율은 "
